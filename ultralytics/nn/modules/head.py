...
from .block import DFL, BNContrastiveHead, ContrastiveHead, Proto, DyHeadBlockWithDCNV3_prune, DyHeadBlock
from .conv import Conv, DWConv
from .transformer import MLP, DeformableTransformerDecoder, DeformableTransformerDecoderLayer
from .utils import bias_init_with_prob, linear_init

__all__ = "Detect", "Segment", "Pose", "Classify", "OBB", "RTDETRDecoder", "v10Detect", "DyHeadBlockWithDCNV3"
...
class Detect_DyHeadWithDCNV3(Detect_DyHead):
    def __init__(self, nc=80, hidc=256, block_num=2, ch=()):
        ...
        self.dyhead = nn.Sequential(*[DyHeadBlockWithDCNV3_prune(hidc) for i in range(block_num)])
